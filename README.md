...
A simple, compact, plug-and-play, well optimized and realistic Arduino-based model railway crossing automation with bidirectional train detection, optical sensors, realistic fading signal lights and fail-safe logic.
